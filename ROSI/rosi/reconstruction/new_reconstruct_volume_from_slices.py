...
#The entire reconstruction pipeline of NiftyMIC is run using this script. It has been slightly modified to be initialized with specified slice parameters.
#Differents components of this script are  :
#1. Brain Segmentation 
#2. Correction of bias fields
#3. SVR reconstruction in subject space using specified input parameters as initialisation
