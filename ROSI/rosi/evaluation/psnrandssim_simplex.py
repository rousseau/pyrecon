...
for test_simplex in val_simplex : 
    fileExt = r".joblib"
    dir_path = '../../res/simplex/value%d/simul_data/simplex%d' %(test_simplex) #lien vers les fichiers résultats
    fichiers = [f for f in listdir(dir_path) if f.endswith(fileExt)]
