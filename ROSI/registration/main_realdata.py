...
import numpy as np
import time
from faster_code.registration_all_algo import normalization,computeCostBetweenAll2Dimages,costFromMatrix,global_optimisation
...
if __name__ == '__main__':
    ...
    for i in range(len(args.filenames)):
        ...
        if datamask.shape==im.get_fdata().shape:
            ...
            loadSlice(im,mask,listSlice,i_image,i_image)
