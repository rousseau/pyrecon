...
from rosi.simulation.simul3Ddata import extract_mask,simulate_motion_on_slices
...
#The function 'simulate_motion_on_slices' simulates a LR image with inter-slice motion from an HR image.
...
if __name__ == '__main__':
    ...
    LrAxNifti,AxMask,paramAx,transfoAx = simulate_motion_on_slices(HRnifti,motion,motion,6,'axial',binaryMask.get_fdata(),True)#create an axial volume
    LrCorNifti,CorMask,paramCor,transfoCor = simulate_motion_on_slices(HRnifti,motion,motion,6,'coronal',binaryMask.get_fdata(),True) #create a coronal volume
    LrSagNifti,SagMask,paramSag,transfoSag = simulate_motion_on_slices(HRnifti,motion,motion,6,'sagittal',binaryMask.get_fdata(),True)#create a sagittal volume
    ...
    LrAxNifti,AxMask,paramAx,transfoAx = simulate_motion_on_slices(HRnifti,motion,motion,6,'axial',binaryMask.get_fdata(),False)#create an axial volume
    LrCorNifti,CorMask,paramCor,transfoCor = simulate_motion_on_slices(HRnifti,motion,motion,6,'coronal',binaryMask.get_fdata(),False) #create a coronal volume
    LrSagNifti,SagMask,paramSag,transfoSag = simulate_motion_on_slices(HRnifti,motion,motion,6,'sagittal',binaryMask.get_fdata(),False)#create a sagittal volume
