...
for value_optimisation in optimisation:
    ...
    for index_image in range(1,6):
        ...
        petit = '../../res/multi/%s/value/simul_data/tres_petit%d/%s/res_test_%s_v2.joblib.gz' %(value_optimisation,index_image,value_optimisation,value_optimisation)
    ...
    for index_image in range(1,6):
        ...
        petit = '../../res/multi/%s/value/simul_data/Petit%d/%s/res_test_%s_v2.joblib.gz' %(value_optimisation,index_image,value_optimisation,value_optimisation)
...
for value_optimisation in optimisation:
    ...
    for index_image in range(1,6):
        ...
        petit = '../../res/multi/%s/value/simul_data/Moyen%d/%s/res_test_%s_v2.joblib.gz' %(value_optimisation,index_image,value_optimisation,value_optimisation)
        #directory1 = '/home/mercier/Documents/donnee/test/Grand%d/' %(i)
...
for value_optimisation in optimisation:
    ...
    for index_image in range(1,6):
        ...
        petit = '../../res/multi/%s/value/simul_data/Grand%d/%s/res_test_%s_v2.joblib.gz' %(value_optimisation,index_image,value_optimisation,value_optimisation)
        #directory1 = '/home/mercier/Documents/donnee/test/Grand%d/' %(i)
...
fig,axs = plt.subplots(len(optimisation),len(motionRange),figsize=(15*len(optimisation),15*len(motionRange)))
...
plt.savefig('cumulative_tre_multi_start_v4.png')
