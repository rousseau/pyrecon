...
for file in ${images_list}
	...
	fonction(){
			 ...
			 docker exec nesvor_contener reconstruct --input-slices ${input_rosi_docker} --output-volume ${output_nesvor_image} --registration none  --no-transformation-optimization  --output-resolution 0.5  --inference-batch-size 255  --n-inference-samples 128 
