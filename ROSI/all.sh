...
for file in ${images_list}
	...
	fonction(){
		     ...
		     #
			 python ROSI/main_realdata.py --filenames $list  --filenames_masks $list_mask  --output $output_registration  --ablation no_multistart no_dice Nelder-Mead --hyperparameters 4 0.25 2000 2 1 0 
		     ...
		     docker cp ${output_registration}'_mvt' wizardly_brattain:'/app/NiftyMIC/ipta/'${file1}'/'${file2}'/all/res_test_all_mvt'
