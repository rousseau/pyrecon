...
value_simplex=["0.3","0.1","0.01"]



for test_simplex in value_simplex:
    errorlist=[]
    psnrlist=[]
    ssimlist=[] 
    for index_image in range(1,5):
        #error_before=[]
        file = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/tres_petit%d/simplex%s/simplex%s' %(test_simplex,index_image,test_simplex,test_simplex)
        petit = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/tres_petit%d/simplex%s/res_test_simplex%s.joblib.gz' %(test_simplex,index_image,test_simplex,test_simplex)
        directory = '/mnt/Data/Chloe/simu/tres_petit%d/' %(index_image)
...
for test_simplex in value_simplex:    
    ...
    for index_image in range(1,5):
        ...
        file='/mnt/Data/Chloe/res/simplex/value%s/simul_data/Petit%d/simplex%s/simplex%s' %(test_simplex,index_image,test_simplex,test_simplex)
        petit = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/Petit%d/simplex%s/res_test_simplex%s.joblib.gz' %(test_simplex,index_image,test_simplex,test_simplex)
        #directory1 = '/home/mercier/Documents/donnee/test/Grand%d/' %(i)
        directory = '/mnt/Data/Chloe/simu/Petit%d/' %(index_image)
        print(petit,os.path.exists(petit))
...
for test_simplex in value_simplex:
    ...
    for index_image in range(1,5):
        ...
        file = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/Moyen%d/simplex%s/simplex%s' %(test_simplex,index_image,test_simplex,test_simplex)
        petit = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/Moyen%d/simplex%s/res_test_simplex%s.joblib.gz' %(test_simplex,index_image,test_simplex,test_simplex)
        #directory1 = '/home/mercier/Documents/donnee/test/Grand%d/' %(i)
        directory = '/mnt/Data/Chloe/simu/Moyen%d/' %(index_image)
...
for test_simplex in value_simplex:
    ...
    for index_image in range(1,5):
        ...
        petit = '/mnt/Data/Chloe/res/simplex/value%s/simul_data/Grand%d/simplex%s/res_test_simplex%s.joblib.gz' %(test_simplex,index_image,test_simplex,test_simplex)
        #directory1 = '/home/mercier/Documents/donnee/test/Grand%d/' %(i)
        directory = '/mnt/Data/Chloe/simu/Grand%d/' %(index_image)
        print(petit,os.path.exists(petit))
...
for test_simplex in range(len(value_simplex)):
        print('test :',test_simplex)
        ...
        for mvt in range(0,4):
            ...
            data=datalist[test_simplex]
        
                #print(len(before))
                #print(len(data))
                
                #add error from each simplex test
            ...
            if len(data)==len(nous_before):
                ...
                axs[test_simplex].scatter(data,nous_before,marker='.',s=170,alpha=0.1,c=color[mvt])
                axs[test_simplex].set_ylabel('avant recalage',fontsize=15)
                axs[test_simplex].set_xlabel('après recalage',fontsize=15)
                axs[test_simplex].set_title(('simplex=%s' %(value_simplex[test_simplex])),fontsize=15) 
                axs[test_simplex].set_ylim(0,16)
                axs[test_simplex].set_xlim(0,5)

        for tick in axs[test_simplex].xaxis.get_majorticklabels():  # example for xaxis
                tick.set_fontsize(15) 

        for tick in axs[test_simplex].yaxis.get_majorticklabels():  # example for xaxis
                tick.set_fontsize(15) 
...
plt.savefig('simplex_test.png')

for i in range(0,len(value_simplex)):
    
    print('simplex :',value_simplex[i])
    print('PSNR')
