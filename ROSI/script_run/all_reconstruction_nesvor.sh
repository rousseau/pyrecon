...
for file in ${images_list}
	...
	fonction(){
		     ...
		     do
			 	 d=${doc//'/home/aorus-users/data_inter/'}
				 echo $doc
			 ...
			 docker exec nesvor_contener nesvor register --input-stacks "${list_docker[@]}" --mask-docker "${mask_docker[@]}" --output-slices $output_svort_docker
