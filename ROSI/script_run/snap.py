    ...
    for subject in subjects:
        ...
        for session in sessions:
            ...
            #== "sub-0002" and session == "ses-0002":
                ...
                path_to_volume = os.path.join(path_to_reconstruction,subject,session,"haste/default_reconst/", "%s_%s_acq-haste_rec-nesvor_desc-brainmask_T2w.nii.gz" %(subject,session))
