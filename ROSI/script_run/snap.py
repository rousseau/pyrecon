    ...
    for subject in subjects:
        ...
        for session in sessions:
            ...
            if subject == "sub-0002" and session == "ses-0002":
                ...
                path_to_volume = os.path.join(path_to_reconstruction,subject,session,"srr_template.nii.gz")
                path_to_mask = os.path.join(path_to_reconstruction,subject,session, "srr_template_mask.nii.gz")
